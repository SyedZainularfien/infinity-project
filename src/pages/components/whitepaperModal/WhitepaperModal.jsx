...
const WhitepaperModal = ({ closeModal }) => {
  ...
  const handleFileDownload = () => {
    const fileUrl = "/document/Infinity-Digital-Assets-Whitepaper.pdf";
    const a = document.createElement("a");
    a.href = fileUrl;
    a.download = "Infinity-Digital-Assets-Whitepaper.pdf";
    a.click();
  };
    ...
    >
      {iframeModalOpen && (
        <PdfViewer
          ...
          iframeUrl="/document/Infinity-Digital-Assets-Whitepaper.pdf"
        />
      )}
          ...
          <div className="flex flex-col items-center p-6 py-10 text-center">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex justify-center gap-3">
                ...
                {/* <div>
                  <img
                    src="https://images.infinitydigitalassets.io/assets/icons/congratsLogo.svg"
                    alt="Success"
                    width={30}
                    height={30}
                  />
